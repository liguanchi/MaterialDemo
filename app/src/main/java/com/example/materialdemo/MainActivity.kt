...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.navView.setNavigationItemSelectedListener {
            when (it.itemId) {
                R.id.navCall -> Toast.makeText(this, "电话", Toast.LENGTH_LONG).show()
                R.id.navDown -> Toast.makeText(this, "锁", Toast.LENGTH_LONG).show()
                R.id.navBlock -> Toast.makeText(this, "下载", Toast.LENGTH_LONG).show()
                R.id.navMsg -> Toast.makeText(this, "定位", Toast.LENGTH_LONG).show()
                R.id.navLoad -> Toast.makeText(this, "消息", Toast.LENGTH_LONG).show()
            }
        ...
        mBinding.fab.setOnClickListener { view ->
            Snackbar.make(view, "悬浮按钮", Snackbar.LENGTH_LONG)
                .setAction("我可以被点击") {
                    Snackbar.make(it, "你点击了弹出式通知", Snackbar.LENGTH_LONG).show()
                }
                .show()
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.no_see -> Toast.makeText(this, "你点击了不可见图标", Toast.LENGTH_LONG).show()
            R.id.msg -> Toast.makeText(this, "你点击了消息图标", Toast.LENGTH_LONG).show()
            R.id.count -> Toast.makeText(this, "你点击了统计图标", Toast.LENGTH_LONG).show()
